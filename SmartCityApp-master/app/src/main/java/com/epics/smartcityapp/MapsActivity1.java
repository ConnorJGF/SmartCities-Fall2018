...
public class MapsActivity1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create class object
        gpsTracker = new GPSTracker(MapsActivity1.this);
...
//            Toast.makeText(getApplicationContext(), "Your Location is - \nLat: " + lat + "\nLong: " + lng, Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(final LatLng latLng) {
                Intent edit = new Intent(MapsActivity1.this, EditActivity.class);
                edit.putExtra("location", latLng);
                MapsActivity1.this.startActivityForResult(edit, EDIT_REQUEST);
            }
    ...
    private class GetCoordinates extends AsyncTask<String, Void, String> {
        ProgressDialog dialog = new ProgressDialog(MapsActivity1.this);
